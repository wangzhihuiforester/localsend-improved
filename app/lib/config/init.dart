...
// WebRTC 已禁用（见下方 postInit 中的说明），相关导入一并注释以避免未使用导入警告。
// 如需重新启用 WebRTC，请同时取消此处与 postInit 中 if (webRTCEnabled) 块的注释。
// import 'package:localsend_app/provider/network/webrtc/signaling_provider.dart';
import 'package:localsend_app/provider/persistence_provider.dart';
// [FOSS_REMOVE_START]
// 应用内购买已禁用（见下方 postInit 中的说明），导入一并注释以避免未使用导入警告。
// 保留 FOSS_REMOVE 标记以兼容 F-Droid 构建脚本。
